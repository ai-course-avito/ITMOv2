...
- Эксперимент и промпт: [`experiment.md`](experiment.md) (техника Tree of Thoughts, строка Tree of Thoughts в [`../prompts.md`](../prompts.md)).
- Исходный артефакт: `practices/practice_01/tests_load.md` (создан по строке P1-03 в `practices/practice_01/prompts.md`).
- Что проверили и исправили сами: сравнили 3 стратегии переписывания по 4 критериям, выбрали стратегию C (инструментальная на k6), проверили добавление скрипта `load_test.js`, сценарий деградации (11 с -> 504) и сохранение порогов REL-1/API-1.
