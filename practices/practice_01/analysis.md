...
- Что проверили и исправили сами: проверили, что каждый шаг TO BE подтверждён конкретным правилом из CASE.md (SEC-1, API-1, REL-1, OUT-1, OBS-1) и строкой из TRAINING_PR.diff
