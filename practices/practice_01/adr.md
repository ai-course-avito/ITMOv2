...
- Что проверили и исправили сами: сверил решение и все четыре альтернативы с правилами `CASE.md`. Забраковал обоснование отказа от очереди: `OBS-1` — правило про логи, а не про хранилище, подмена заменена на реальные минусы очереди. Статус оставил `proposed`, поскольку ни одна проверка из плана ещё не выполнена
